        ...
        $profileData = App\Models\User::find($id);
            ...
            <div class="user-box dropdown px-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('admin.profile')}}"><i class="bx bx-user fs-5"></i><span>Hesabım</span></a>
                    </li>
                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('admin.change.password')}}"><i class="bx bx-cog fs-5"></i><span>Şifremi Değiştir</span></a>
                    </li>
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('admin.logout')}}"><i class="bx bx-log-out-circle"></i><span>Çıkış Yap</span></a>
                    </li>
                </ul>
            </div>
        </nav>
