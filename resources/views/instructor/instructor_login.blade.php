...
<body class="">
	...
	<div class="wrapper">
		<div class="section-authentication-cover">
							...
							<div class="card-body p-sm-5">
								<div class="">
									...
									<div class="text-center mb-4">
										<h5 class="">Öğretmen Girişi</h5>
										<p class="mb-0">Öğretmen Hesabınızla Giriş Yapınız</p>
									</div>
									<div class="form-body">
            ...
            <div class="col-md-6 text-end">	<a href="authentication-forgot-password.html">Şifremi Unuttum</a>
            </div>
            <div class="col-12">
                <div class="d-grid">
