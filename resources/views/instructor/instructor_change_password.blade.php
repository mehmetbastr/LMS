...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Öğretmen Şifre Değiştir</div>
        <div class="ps-3">
    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-sm-3">
                        <h6 class="mb-0">Eski Şifreniz</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                        <input type="password" name="old_password" class="form-control @error('old_pasword') is-invalid @enderror" id="old_password" />
                        @error('old_password')
                ...
                <div class="row mb-3">
                    <div class="col-sm-3">
                        <h6 class="mb-0">Yeni Şifrenizi Onaylayın</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
